...
#define BIND_SIBLING_CENTER_H(PARENT, SIB1, SIB2, CONST) {BIND_SIBLING_EDGE(PARENT, SIB1, SIB2, NSLayoutAttributeCenterX, CONST);}
#define BIND_SIBLING_CENTER_V(PARENT, SIB1, SIB2, CONST) {BIND_SIBLING_EDGE(PARENT, SIB1, SIB2, NSLayoutAttributeCenterY, CONST);}
#define BIND_SIBLING_CENTER(PARENT, SIB1, SIB2) {BIND_SIBLING_CENTER_H(PARENT, SIB1, SIB2, 0.0f); BIND_SIBLING_CENTER_V(PARENT, SIB1, SIB2, 0.0f);}
